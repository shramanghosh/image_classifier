...
def main():
    ...
    def training_model(model_name, hidden_units,epoch_number,learn_rate):
            ...
            for inputs,labels in trainloader: 
                ...
                if steps % print_every == 0:#every 5 steps we drop out of training loop to test accuracy
                    ...
                    print(f"Epoch {e+1}/{epochs}.. " #Keep track of where we are
                          ...
                          f"Validation accuracy: {valid_accuracy/len(validloader): .3f}") #Average accuracy
        ...
        return model, model.state_dict(), model.classifier, model.class_to_idx, input_units
